...
function App() {
  return (
    <div className="max-w-[1044px] mx-auto flex flex-col items-center m-8">
      ...
      <div className="grid grid-cols-6 gap-6 mt-10" >
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-4.png" alt="" />
            <div className="w-full  pt-16 pd-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            <strong className="font-bold text-white block">Apex Legents</strong>
            <span className="text-zinc-300 text-sm block">4 anúncios</span>
          </div>
        </a>
        <a href="" className="relative rounded-lg overflow-hidden">
      ...
      <div className="pt-1 bg-nlw-gradient self-stretch rounded-lg mt-4 overflow-hidden">
        <div className="bg-[#2A2634] px-4 py-4 flex justify-between items-center">
            <div>
